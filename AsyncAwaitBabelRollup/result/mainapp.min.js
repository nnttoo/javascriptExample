var mainapp = (function (exports) {
	...
	*/
	...
	var FORCED$1 = NEGATIVE_ZERO$1 || !STRICT_METHOD$3 || !USES_TO_LENGTH$7;
	...
	var USES_TO_LENGTH$a = arrayMethodUsesToLength('reduceRight', { 1: 0 });
	...
	var FORCED$8 = descriptors && isForced_1('RegExp', (!CORRECT_NEW || UNSUPPORTED_Y$1 || fails(function () {
	  re2[MATCH$1] = false;
	...
	var FORCED$9 = stringTrimForced('trimEnd');
	...
	var addGetter = function (Constructor, key) {
	  defineProperty$9(Constructor[PROTOTYPE$2], key, { get: function () { return getInternalState$4(this)[key]; } });
	};
	...
	var $AggregateError = function AggregateError(errors, message) {
	  ...
	  if (descriptors) setInternalState$8(that, { errors: errorsArray, type: 'AggregateError' });
	...
	var hex = /^[+-]?0[Xx]/;
	var FORCED$d = $parseInt(whitespaces + '08') !== 8 || $parseInt(whitespaces + '0x16') !== 22;
	...
	var FORCED$e = !global_1.setImmediate || !global_1.clearImmediate;

	// http://w3c.github.io/setImmediate/
	_export({ global: true, bind: true, enumerable: true, forced: FORCED$e }, {
	  // `setImmediate` method
